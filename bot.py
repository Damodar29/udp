...
"""
export YOUR_TELEGRAM_TOKEN=7282472176:AAFzUDuPDdOZrBawfOCgR9RtPwl8KplrsL8

/usr/bin/python3 -m pip install --upgrade pip
pip3 uninstall telegram && pip3 uninstall telegram-bot python-telegram-bot && 
...
python3 ~/MHDDoS/start.py GET panpan-bot1.glitch.me 1 100 mhddos_proxy/list 100 5
"""
...
#Telegram token
#token = os.getenv('7282472176:AAFzUDuPDdOZrBawfOCgR9RtPwl8KplrsL8')
print(token)
input('check:')


bot_number = '@Damdosbot'
