...
def main():
    ...
    while True:
        try:
            times_input = '12000' #input("\033[1;31m[#]\033[0m ""\033[1;37mEnter packets per connection: \033[0m ")
    ...
    while True:
        try:
            threads_input = '40' #input("\033[1;31m[#]\033[0m ""\033[1;37mEnter number of threads: \033[0m ")
